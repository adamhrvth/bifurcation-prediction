...
savedFileName = "sys2_c1_0_5_c3_3ranges_IC_0_7_4_1600samples.mat";
...
c3RangeClose = [0.985, 0.995] * c3Crit;
...
[tS, xS] = runSimulation(@system_dyn_2_fun, c1, c3RangeStable, x0Range, paramPointsStable, initPoints, tspan);
[tC, xC] = runSimulation(@system_dyn_2_fun, c1, c3RangeClose, x0Range, paramPointsClose, initPoints, tspan);
[tB, xB] = runSimulation(@system_dyn_2_fun, c1, c3RangeBif, x0Range, paramPointsBif, initPoints, tspan);
